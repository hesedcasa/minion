...
export function EmptyState({ onOpenProject, onCloneFromUrl }: EmptyStateProps) {
  return (
    <div className="empty-state-container">
      <div className="clonehub-logo">
        <div className="logo-text">CLONEHUB</div>
      </div>
      ...
      <div className="action-cards">
        <button className="action-card" onClick={onOpenProject}>
          ...
          <div className="action-card-text">Open project</div>
        </button>

        <button className="action-card" onClick={onCloneFromUrl}>
          <div className="action-card-icon">
            <svg width="24" height="24" viewBox="0 0 16 16" fill="currentColor">
          ...
          <div className="action-card-text">Clone from URL</div>
        </button>
      </div>
    </div>
  );
